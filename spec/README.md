...
choosing OPFS, Hestia, Ignatius, Tahto or another store. The first save envelope
is an application format above Core and Engine; it deliberately does not move
browser storage into either package. Hara rule formats describe bounded portable
values that a trusted host validates and materializes through Core; they do not
contain dense chunks or host objects.
